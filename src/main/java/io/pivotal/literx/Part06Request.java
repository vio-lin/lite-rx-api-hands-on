...
public class Part06Request {
  ...
  Flux<User> fluxWithLog() {
    return repository.findAll().doOnSubscribe(a-> System.out.println(a));
  }
  ...
  Flux<User> fluxWithDoOnPrintln() {
    return repository.findAll().doOnSubscribe(a->System.out.println("Starring:")).doOnNext(a-> System.out.println(a.getFirstname()+a.getLastname()))
